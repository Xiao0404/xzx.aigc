<template>
    ...
    <div class="container bg-gradient-to-b from-pink-300 to-white-200" >
        ...
        <div class="container-greet">
            <span style="font-weight: bold;">Hi,我是新闻助手 NewNews</span><br>
            <span style="margin-top: 0.15rem;display: block;">我可以给你推荐你感兴趣的新闻哦~</span>
        </div>
    ...
    <div class=" inputAndRecommend">
        <ul class="recommendList">
            <li v-for="(item, index) in recommendQuestion" :key="index" @click="recommendClick(item)" v-if="!isLoading"
        ...
        <van-cell-group>
            <van-field v-model="newQuestion" center clearable placeholder="请输入您的想要问的新闻">
                <template #button>
                    ...
                    <van-loading vertical v-else>
                        <template #icon>
                            <van-icon name="weapp-nav" size="1rem" />
                        </template>
                        回答生成中...
                    </van-loading>
                </template>
