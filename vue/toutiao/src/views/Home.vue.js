...
function __VLS_template() {
    ...
    [SwipeTab,];
    // @ts-ignore
    const __VLS_6 = __VLS_asFunctionalComponent(SwipeTab, new SwipeTab({}));
    const __VLS_7 = __VLS_6({}, ...__VLS_functionalComponentArgsRest(__VLS_6));
    ({}({}));
    const __VLS_10 = __VLS_nonNullable(__VLS_pickFunctionalComponentCtx(SwipeTab, __VLS_7));
    // @ts-ignore
    const __VLS_11 = {}
        .VanBackTop;
    ({}.VanBackTop);
    __VLS_components.VanBackTop;
    __VLS_components.vanBackTop;
    // @ts-ignore
    [VanBackTop,];
    // @ts-ignore
