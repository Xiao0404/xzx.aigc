<template>
  <div class="note-class-wrapper">
      <div class="note-class" :class="{'hide':menuVisible}">
          <header>
              <div @click="menuVisible = true"><van-icon name="wap-nav"  /></div>
              <div>
                  <van-icon name="edit" />
      ...
      <!-- menu -->
      <Menu class="menu " v-model:menuVisible="menuVisible" :class="{'show':menuVisible}"  />
